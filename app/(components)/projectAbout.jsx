...
export default function projectAbout() {
  return (
    <div className="p-4 py-12 border-b border-gray-5 ">
        <h3 className="text-2xl mb-4 font-semibold">What are we all about? </h3>
        <p>
          ...
          using real money. <br /> This educational tool offers a realisic rading experience, 
